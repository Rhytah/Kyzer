      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-text-dark">Choose account type</h3>
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-text-dark">Individual</p>
                    <p className="text-xs text-text-light mt-1">Personal learning account</p>
                  </div>
                  {accountType === 'individual' && (
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-text-dark">Corporate</p>
                    <p className="text-xs text-text-light mt-1">Up to 200 employees</p>
                  </div>
                  {accountType === 'corporate' && (
                    <Check className="w-4 h-4 text-primary" />
                  )}
        ...
        <div className="flex items-center justify-center w-full p-12">
          <div className="text-center text-white max-w-lg">
            ...
            <p className="text-lg text-gray-200 mb-8">
              Join thousands of learners advancing their careers with our comprehensive courses and professional certificates.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8">
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-200">Access to all course materials</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-green-300" />
                  <span className="text-gray-200">Progress tracking & analytics</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Check className="w-5 h-5 text-green-300" />
                ...
                {accountType === 'corporate' && (
                  <>
                    <div className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-300" />
                      <span className="text-gray-200">Team management tools</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-green-300" />

        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl border border-background-dark">
                ...
                <div className="p-6">
                  <div className="flex items-center space-x-6 mb-8">
                    ...
                    <div className="relative">
                      ...
                      <label htmlFor="profile-image" className="absolute bottom-0 right-0 w-8 h-8 bg-primary rounded-full flex items-center justify-center cursor-pointer hover:bg-primary-dark transition-colors">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    {user?.profile?.account_type === 'corporate' && (
                      <div>
                        <h3 className="text-lg font-medium text-text-dark mb-4">Professional Information</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-sm font-medium text-text-dark mb-2">
                              Company name
              ...
              {activeTab === 'account' && (
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-text-dark mb-6">Account Settings</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-background-dark rounded-lg p-4">
                      <h3 className="font-medium text-text-dark mb-2">Password</h3>
                    ...
                    <div className="border border-background-dark rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-medium text-text-dark">Two-Factor Authentication</h3>
              ...
              {activeTab === 'notifications' && (
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    {/* Email Notifications */}
                    <div>
                      <h3 className="font-medium text-text-dark mb-4">Email Notifications</h3>
                      <div className="space-y-3">
                        <label className="flex items-center justify-between">
                          <span className="text-text-dark">Course updates and announcements</span>
                          <input type="checkbox" className="toggle" defaultChecked />
                        </label>
                        <label className="flex items-center justify-between">
                          <span className="text-text-dark">New course recommendations</span>
                          <input type="checkbox" className="toggle" />
                        </label>
                        <label className="flex items-center justify-between">
                          <span className="text-text-dark">Marketing emails</span>
                          <input type="checkbox" className="toggle" />
                        </label>
                      </div>
                    </div>
                    ...
                    {/* Push Notifications */}
                    <div>
                      <h3 className="font-medium text-text-dark mb-4">Push Notifications</h3>
                      <div className="space-y-3">
                        <label className="flex items-center justify-between">
                          <span className="text-text-dark">Assignment reminders</span>
                          <input type="checkbox" className="toggle" defaultChecked />
                        </label>
                        <label className="flex items-center justify-between">
                          <span className="text-text-dark">Achievement notifications</span>
                          <input type="checkbox" className="toggle" defaultChecked />
                        </label>
                      </div>
                    </div>
              ...
              {activeTab === 'privacy' && (
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-text-dark mb-6">Privacy Settings</h2>
                  
                  <div className="space-y-6">
                    <div className="border border-background-dark rounded-lg p-4">
                      <h3 className="font-medium text-text-dark mb-2">Profile Visibility</h3>
                      <p className="text-sm text-text-light mb-4">
                    ...
                    <div className="border border-background-dark rounded-lg p-4">
                      <h3 className="font-medium text-text-dark mb-2">Data Export</h3>
                      <p className="text-sm text-text-light mb-4">

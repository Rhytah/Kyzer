      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-background-medium">
            <div className="flex items-center space-x-4">
              <label className="flex items-center space-x-2">
                ...
                />
                <span className="text-sm text-text-medium">Free courses only</span>
              </label>
            </div>
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, index) => (
              <div key={index} className="bg-white rounded-xl border border-background-dark overflow-hidden">
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-text-dark mb-2">No courses found</h3>
            <p className="text-text-light">

...
//           state={{
//             message:
//               "You need to set up a company account to access corporate features.",
//           }}
//           replace
//         />
//       );
...
//         </h2>
//         <p className="text-text-light mb-6">
//           You don't have permission to {message}. Please contact your company
//           administrator.
//         </p>
...
//         <div className="space-y-3">
//           <Button variant="primary" onClick={() => fetchCurrentCompany()}>
//             Try Again
//           </Button>
...
export default function CorporateGuard({
  ...
  // Handle redirect-only case first
  if (!children && redirectTo) {
    if (!currentCompany) {
      return <Navigate to="/dashboard" replace />;
    }
  ...
  // User doesn't have a company - redirect to setup or show message
  if (!currentCompany) {
    if (location.pathname.startsWith("/company")) {
      return (
        <Navigate

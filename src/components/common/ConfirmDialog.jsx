        ...
        <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
          ...
          <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse sm:gap-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="mt-3 inline-flex w-full justify-center rounded-lg border border-background-dark bg-white px-4 py-2 text-sm font-medium text-text-dark hover:bg-background-light transition-colors sm:mt-0 sm:w-auto"
            >
              {cancelText}
            </button>
          </div>

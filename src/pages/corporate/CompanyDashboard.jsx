          ...
          <div className="card">
            ...
            <div className="space-y-4">
              {recentActivity.map((activity) => (
                <div
                  key={activity.id}
                  className="flex items-start space-x-3 p-3 hover:bg-background-light rounded-lg transition-colors"
                >
              ...
              {upcomingDeadlines.map((deadline) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs text-text-medium mb-2">
                    ...
                    <span>
                      {deadline.completedCount}/{deadline.assignedCount}{" "}
                      completed
                    </span>
                  </div>
                  <div className="progress-bar h-1">
                    <div
                      className="progress-fill"
                      style={{
                        width: `${(deadline.completedCount / deadline.assignedCount) * 100}%`,
                      }}
                    />
                  </div>
                </div>

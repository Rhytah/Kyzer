-- Fix Owner Role Constraint and Update Creators
-- Purpose: Drop constraint, update data, then recreate constraint
-- Date: 2025-01-XX
--
-- This must be done in order:
-- 1. Drop the constraint (so we can update data)
-- 2. Update existing invalid roles
-- 3. Update creators to owner role
...
-- ============================================
-- STEP 2: Update any invalid roles to valid ones
-- ============================================
...
SET role = CASE
    ...
    WHEN role IS NULL THEN 'learner' -- Handle NULL roles
...
-- ============================================
-- STEP 4: Create missing memberships for creators
-- ============================================
...
-- ============================================
-- STEP 5: Recreate the constraint (NOW that all data is valid)
-- ============================================
